...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_folder", type=str, default="data/custom1/images", help="path to dataset")
    ...
    parser.add_argument("--class_path", type=str, default="data/custom1/classes.names", help="path to class label file")
