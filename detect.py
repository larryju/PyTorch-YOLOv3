...
if __name__ == "__main__":
    ...
    parser.add_argument("--class_path", type=str, default="data/face/classes.names", help="path to class label file")
    ...
    for batch_i, (img_paths, input_imgs) in enumerate(dataloader):
        with torch.no_grad():
            print(input_imgs.max(), input_imgs.size())
    ...
    for img_i, (path, detections) in enumerate(zip(imgs, img_detections)):
        ...
        if detections is not None:
            ...
            print(detections.size(), opt.img_size, img.shape[:2])
